...
public class AutocastInterface extends Interface {
    ...
    private enum AutocastPage {
        ...
        ANCIENT(4675, new EnumBuilder<CombatSpell>()
                ...
                .build(),
                (player, name) -> onSpellbook(player, Spellbook.ANCIENT) && (name.equals("Eldritch nightmare staff") || name.equals("Volatile nightmare staff") ||
                        name.equals("Ancient sceptre") || name.equals("Nightmare staff") || name.equals("Master wand") || name.equals("Kodai wand") || name.equals("Ancient staff") || player.getCombatDefinitions().hasFullAhrimsAndDamned())),
