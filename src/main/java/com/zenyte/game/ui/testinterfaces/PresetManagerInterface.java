                ...
                if (presetManager.canPurchaseFreeSlot()) {
                    player.getDialogueManager().start(new Dialogue(player) {
                        ...
                        public void buildDialogue() {
                            ...
                            plain("You do not have any available preset slots remaining. You can unlock up to " + unlockableSlotsCount + " more preset" + (unlockableSlotsCount == 1 ? "" : "s") + ". Each unlock costs " + Colour.RED.wrap("five") + " vote points. You currently have " + availableVotePoints + " vote point" + (availableVotePoints == 1 ? "" : "s") + ".");
