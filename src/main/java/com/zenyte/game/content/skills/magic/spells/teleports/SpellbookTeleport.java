...
import com.zenyte.game.ui.testinterfaces.advancedsettings.SettingStructs;
import com.zenyte.game.ui.testinterfaces.advancedsettings.SettingVariables;
import com.zenyte.game.ui.testinterfaces.advancedsettings.Settings;
...
public enum SpellbookTeleport implements TeleportSpell, Teleport {
    ...
    public void execute(final Player player, final int optionId, final String option) {
        ...
        if (structId != -1) {
            final com.zenyte.game.ui.testinterfaces.advancedsettings.Setting setting =
                    Settings.findSettingByStructId(structId);
            if (optionId == 10) {
