...
public enum PocketData {
    ...
    AL_KHARID_WARRIOR(25, -15, 26, CoinPouch.WARRIOR, true, 5, 2, 2, new String[]{"What do you think you're doing?"}, new ImmutableItem[]{new ImmutableItem(CoinPouch.WARRIOR.getItemId())}, NpcId.AL_KHARID_WARRIOR),
