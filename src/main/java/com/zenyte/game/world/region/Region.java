    ...
    public void loadRegionMap() {
        try {
            ...
            if (landBuffer != null) {
                ...
                while ((incr = landBuffer.readHugeSmart()) != 0) {
                    ...
                    while ((incr2 = landBuffer.readUnsignedSmart()) != 0) {
                        ...
                        spawnObject(new WorldObject(Edenify.offsetObject(regionId, objectId), type, rotation,
            ...
            if (log.isErrorEnabled()) {
                log.error("Failed to load region " + regionId + " where xteas are " + Arrays.toString(XTEALoader.getXTEAs(regionId)), e);
            }
        }
    }
