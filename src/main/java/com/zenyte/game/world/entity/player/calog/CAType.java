...
public enum CAType {
	...
	SHAYZIEN_PROTECTOR(175, "Shayzien Protector", CATierType.EASY, 60),
	...
	PRAY_FOR_SUCCESS(27, "Pray for Success", CATierType.MEDIUM, 3),
	...
	QUICK_CUTTER(38, "Quick Cutter", CATierType.MEDIUM, 4),
	...
	SORRY_WHAT_WAS_THAT(63, "Sorry, What Was That?", CATierType.MEDIUM, 8),
	CRAZY_ARCHAEOLOGIST_CHAMPION(70, "Crazy Archaeologist Champion", CATierType.MEDIUM, 9),
	MAGE_OF_THE_RUINS(72, "Mage of the Ruins", CATierType.MEDIUM, 9),
	ID_RATHER_NOT_LEARN(73, "I'd Rather Not Learn", CATierType.MEDIUM, 9),
	...
	CLAW_CLIPPER(164, "Claw Clipper", CATierType.MEDIUM, 25),
	...
	AVOIDING_THOSE_LITTLE_ARMS(182, "Avoiding Those Little Arms", CATierType.MEDIUM, 21),
	...
	PRAYING_TO_THE_GODS(64, "Praying to the Gods", CATierType.HARD, 8),
	...
	WEED_WHACKER(125, "Weed Whacker", CATierType.HARD, 23),
	KALPHITE_QUEEN_ADEPT(157, "Kalphite Queen Adept", CATierType.HARD, 24),
	CHITIN_PENETRATOR(159, "Chitin Penetrator", CATierType.HARD, 24),
	...
	WHACK_A_MOLE(181, "Whack-a-Mole", CATierType.HARD, 21),
	...
	READY_TO_POUNCE(208, "Ready to Pounce", CATierType.HARD, 35),
	INSPECT_REPELLENT(209, "Inspect Repellent", CATierType.HARD, 35),
	...
	I_CANT_REACH_THAT(220, "I Can't Reach That", CATierType.HARD, 36),
	GUARDIANS_NO_MORE(221, "Guardians No More", CATierType.HARD, 36),
	...
	VETION_ADEPT(266, "Vet'ion Adept", CATierType.HARD, 50),
	...
	PERFECT_SIRE(8, "Perfect Sire", CATierType.ELITE, 1),
	...
	DEMON_EVASION(47, "Demon Evasion", CATierType.ELITE, 37),
	...
	UNREQUIRED_ANTIFIRE(55, "Unrequired Antifire", CATierType.ELITE, 6),
	ANTI_BITE_MECHANICS(56, "Anti-Bite Mechanics", CATierType.ELITE, 6),
	...
	HOT_ON_YOUR_FEET(67, "Hot on Your Feet", CATierType.ELITE, 12),
	...
	three_2_1__MAGE(101, "3, 2, 1 - Mage", CATierType.ELITE, 19),
	GAUNTLET_VETERAN(109, "Gauntlet Veteran", CATierType.ELITE, 18),
	three_2_1__RANGE(111, "3, 2, 1 - Range", CATierType.ELITE, 18),
	EGNIOL_DIET(114, "Egniol Diet", CATierType.ELITE, 18),
	CRYSTALLINE_WARRIOR(115, "Crystalline Warrior", CATierType.ELITE, 18),
	WOLF_PUNCHER(116, "Wolf Puncher", CATierType.ELITE, 18),
	...
	PRAYER_SMASHER(161, "Prayer Smasher", CATierType.ELITE, 24),
	TEN_TACLES(171, "Ten-tacles", CATierType.ELITE, 26),
	MIMIC_VETERAN(176, "Mimic Veteran", CATierType.ELITE, 29),
	HARD_HITTER(180, "Hard Hitter", CATierType.ELITE, 21),
	...
	NIGHTMARE__5_SCALE__SPEED_TRIALIST(194, "Nightmare (5-Scale) Speed-Trialist", CATierType.ELITE, 31),
	DEATH_TO_THE_SEER_KING(199, "Death to the Seer King", CATierType.ELITE, 14),
	FROM_ONE_KING_TO_ANOTHER(200, "From One King to Another", CATierType.ELITE, 14),
	...
	TOGETHER_WELL_FALL(303, "Together We'll Fall", CATierType.ELITE, 10),
	REDEMPTION_ENTHUSIAST(308, "Redemption Enthusiast", CATierType.ELITE, 10),
	MUTTA_DIET(307, "Mutta-diet", CATierType.ELITE, 10),
	DANCING_WITH_STATUES(311, "Dancing with Statues", CATierType.ELITE, 10),
	...
	CRYO_NO_MORE(316, "Cryo No More", CATierType.ELITE, 10),
	BLIZZARD_DODGER(320, "Blizzard Dodger", CATierType.ELITE, 10),
	KILL_IT_WITH_FIRE(321, "Kill It with Fire", CATierType.ELITE, 10),
	...
	DEMONIC_DEFENCE(337, "Demonic Defence", CATierType.ELITE, 28),
	THE_BANE_OF_DEMONS(336, "The Bane of Demons", CATierType.ELITE, 28),
	...
	PRECISE_POSITIONING(50, "Precise Positioning", CATierType.MASTER, 37),
	...
	_TIL_DAWN(96, "... 'til Dawn", CATierType.MASTER, 22),
	...
	WALK_STRAIGHT_PRAY_TRUE(483, "Walk Straight Pray True", CATierType.MASTER, 32),
	SPACE_IS_TIGHT(481, "Space is Tight", CATierType.MASTER, 32),
	THE_WORST_RANGED_WEAPON(14, "The Worst Ranged Weapon", CATierType.GRANDMASTER, 27),
	...
	GROTESQUE_GUARDIANS_SPEED_RUNNER(94, "Grotesque Guardians Speed-Runner", CATierType.GRANDMASTER, 22),
	CORRUPTED_GAUNTLET_GRANDMASTER(100, "Corrupted Gauntlet Grandmaster", CATierType.GRANDMASTER, 19),
	WOLF_PUNCHER_II(106, "Wolf Puncher II", CATierType.GRANDMASTER, 19),
	...
	THEATRE_OF_BLOOD_GRANDMASTER(239, "Theatre of Blood Grandmaster", CATierType.GRANDMASTER, 40),
	MORYTANIA_ONLY(252, "Morytania Only", CATierType.GRANDMASTER, 40),
	FAITHLESS_ENCOUNTER(274, "Faithless Encounter", CATierType.GRANDMASTER, 51),
	THE_FREMENNIK_WAY(275, "The Fremennik Way", CATierType.GRANDMASTER, 51),
	VORKATH_SPEED_RUNNER(277, "Vorkath Speed-Runner", CATierType.GRANDMASTER, 51),
	CHAMBERS_OF_XERIC__CM_GRANDMASTER(289, "Chambers of Xeric: CM Grandmaster", CATierType.GRANDMASTER, 11),
	CHAMBERS_OF_XERIC__CM__5_SCALE__SPEED_RUNNER(296, "Chambers of Xeric: CM (5-Scale) Speed-Runner", CATierType.GRANDMASTER, 11),
	CHAMBERS_OF_XERIC__CM__TRIO__SPEED_RUNNER(298, "Chambers of Xeric: CM (Trio) Speed-Runner", CATierType.GRANDMASTER, 11),
	CHAMBERS_OF_XERIC_GRANDMASTER(301, "Chambers of Xeric Grandmaster", CATierType.GRANDMASTER, 10),
	DEMON_WHISPERER(338, "Demon Whisperer", CATierType.GRANDMASTER, 28),
	ASH_COLLECTOR(340, "Ash Collector", CATierType.GRANDMASTER, 28),
	INFERNO_GRANDMASTER(342, "Inferno Grandmaster", CATierType.GRANDMASTER, 47),
	INFERNO_SPEED_RUNNER(352, "Inferno Speed-Runner", CATierType.GRANDMASTER, 47),
	...
	CANT_WAKE_UP(409, "Can't Wake Up", CATierType.GRANDMASTER, 33),
	...
	PHANTOM_MUSPAH_MANIPULATOR(484, "Phantom Muspah Manipulator", CATierType.GRANDMASTER, 32),
	PHANTOM_MUSPAH_SPEED_RUNNER(477, "Phantom Muspah Speed-Runner", CATierType.GRANDMASTER, 32),
	;
