...
public class NotificationSettings {
    ...
    public static final ImmutableList<String> BOSS_NPC_NAMES = ImmutableList.of("phantom muspah", "deranged archaeologist", "abyssal sire", "vanstrom klause", "sarachnis", "general graardor", "kree'arra", "commander zilyana", "k'ril tsutsaroth", "callisto", "venenatis", "scorpia", "vet'ion", "chaos elemental", "chaos fanatic", "crazy archaeologist", "cerberus", "vorkath", "zulrah", "giant mole", "thermonuclear smoke devil", "king black dragon", "dagannoth rex", "dagannoth supreme", "dagannoth prime", "skotizo", "barrows", "kraken", "grotesque guardians", "hespori", "obor", "bryophyta", "corporeal beast", "tztok-jad", "alchemical hydra", "tzkal-zuk", "mimic", "nex");
