...
public enum Ladder {
    ...
    LUMBRIDGE_CASTLE_TRAPDOOR(new LadderObject(14880, new Location(3205, 3210, 0)), new Location(3209, 9615, 0)),
    LUMBRIDGE_CASTLE_LADDER(new LadderObject(17385, new Location(3209, 9616, 0)), new Location(3210, 3210, 0)),
    ...
    SHIPS_LADDER_UP(new LadderObject(272, new Location(3018, 3957, 0)), new Location(3018, 3956, 1)),
    SHIPS_LADDER_DOWN(new LadderObject(273, new Location(3018, 3956, 1)), new Location(3018, 3957, 0)),
