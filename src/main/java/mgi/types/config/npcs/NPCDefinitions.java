    ...
    public void decode(final ByteBuffer buffer) {
        ...
        while (true) {
            ...
            try {
                ...
                throw new RuntimeException("Failed to decode NPC " + id + ", lastOpcode=" + lastOpcode, e);
            }
        }
    }
        ...
        switch (opcode) {
            case 1: {
                ...
                for (int i = 0; i < size; i++) {
                    models[i] = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.MODELS);
                }
                return;
            }
            case 2:
            ...
            case 12:
                ...
                return;
            case 13:
                standAnimation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                return;
            case 14:
                walkAnimation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                return;
            case 15:
                rotateLeftAnimation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                return;
            case 16:
                rotateRightAnimation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                return;
            case 17:
                walkAnimation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                rotate180Animation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                rotate90Animation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                rotate270Animation = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.ANIMS);
                return;
            case 18:
            ...
            case 60: {
                ...
                for (int i = 0; i < size; i++) {
                    chatModels[i] = Edenify.NPCS.offset(id, buffer.readUnsignedShort(), Edenify.MODELS);
                }
                return;
            }
            case 93:
            ...
            case 106:
            case 118: {
                varbit = Edenify.NPCS.offset65535(id, buffer.readUnsignedShort(), Edenify.VARBIT);
                varp = Edenify.NPCS.offset65535(id, buffer.readUnsignedShort(), Edenify.VARCLIENT);
                finalTransmogrification = -1;
                if (opcode == 118) {
                    finalTransmogrification = Edenify.NPCS.offset65535(id, buffer.readUnsignedShort());
                }
                final int size = buffer.readUnsignedByte();
                transmogrifiedIds = new int[size + 2];
                for (int int_3 = 0; int_3 <= size; int_3++) {
                    transmogrifiedIds[int_3] = Edenify.NPCS.offset65535(id, buffer.readUnsignedShort());
                }
